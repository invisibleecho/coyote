...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.object = function () {
        ...
        this.expect([coyote_types_1.TYPE.LEFT_BRACE], function (token) {
            ...
            while (!_this.finished() && !_this.check(coyote_types_1.TYPE.RIGHT_BRACE))
                fields.push(_this.field());
            _this.expect([coyote_types_1.TYPE.RIGHT_BRACE], function (token) {
                if (!token)
                    throw new Error("Parser Error: Expecting '}' after object fields.");
            });
        });
        return fields;
    };
    ...
    Parser.prototype.decorators = function () {
        ...
        var isField = function () { var _a; return [coyote_types_1.TYPE.QMARK, coyote_types_1.TYPE.COLON, coyote_types_1.TYPE.LEFT_BRACE].includes((_a = _this.peek(1)) === null || _a === void 0 ? void 0 : _a.type); };
        while (isDecorator() && this.expect([coyote_types_1.TYPE.IDENTIFIER], function (token) { return !!token; })) {
            ...
            while (!isField() && !isDecorator() && this.expect([coyote_types_1.TYPE.IDENTIFIER, coyote_types_1.TYPE.NUMBER_LITERAL, coyote_types_1.TYPE.TRUE, coyote_types_1.TYPE.FALSE], function (token) { return !!token; })) {
